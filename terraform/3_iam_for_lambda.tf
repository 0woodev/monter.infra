...
data "aws_iam_policy_document" "default_iam_for_lambda_role" {
  statement {
...
data "aws_iam_policy_document" "default_iam_for_lambda_policy" {
  version = "2012-10-17"
  statement {
    actions = [
      "logs:CreateLogGroup",
...
resource "aws_iam_policy" "default_iam_for_lambda_policy" {
  ...
  policy = data.aws_iam_policy_document.default_iam_for_lambda_policy.json
}

resource "aws_iam_role_policy_attachment" "default_api_service_policy_attachment" {
  role       = aws_iam_role.default_iam_for_lambda_role.name
  policy_arn = aws_iam_policy.default_iam_for_lambda_policy.arn
}
