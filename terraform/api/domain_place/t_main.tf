variable "function_list" {
  default = {
    v1_place_list_get = {
      route_key        = "GET /place/list"
      is_authorized    = false
      handler          = "d_place.v1_place_list_get.v1_place_list_get.lambda_handler"
      source_file_path = "../api/d_place/v1_place_list_get/dist/build.zip"
      layer_file_path  = "../api/d_place/v1_place_list_get/dist/layer.zip"
...
module "monter_api_lambda" {
  ...
  iam_prop = {
    aws_iam_role_arn : aws_iam_role.place_domain_iam_for_lambda_role.arn
